...
public class StudentController {
    ...
    public ResponseEntity<Student> getStudentByName(@PathVariable String name) {
        Student student = studentServiceObj.getStudentByName(name); // Assign student by calling service layer method
    ...
    public ResponseEntity<Teacher> getTeacherByName(@PathVariable String name) {
        Teacher teacher = studentServiceObj.getTeacherByName(name); // Assign student by calling service layer method
    ...
    public ResponseEntity<List<String>> getStudentsByTeacherName(@PathVariable String teacher) {
        List<String> students = studentServiceObj.getStudentsByTeacherName(teacher); // Assign list of student by calling service layer method
